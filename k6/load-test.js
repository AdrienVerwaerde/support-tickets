...
export const options = {
  stages: [
    ...
    { duration: '5m', target: 200 },   // montée linéaire 10 → 200 VUs
    { duration: '2m', target: 200 },   // palier d'observation
...
========================================
  ...
  p(95) latency: ${(dur['p(95)'] ?? 0).toFixed(0)} ms
  avg latency:   ${(dur.avg ?? 0).toFixed(0)} ms
